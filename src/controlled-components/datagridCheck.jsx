...
export function ControlledDemo(){
    ...
    return(
        ...
        <div className="container-fluid">
            ...
            <DataGrid layout={layoutName} caption='Products in Offer' fields={['Name', 'Price', 'Rating']} data={[{Name:'TV', Price:24000, Rating:4.2}, {Name:'Mobile', Price:12000, Rating:3.2}, {Name:'Watch', Price:3000, Rating:4.9}]} />
